...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { more_attributes: @component.more_attributes, name: @component.name, component_type: @component.component_type }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { more_attributes: @component.more_attributes, name: @component.name, component_type: @component.component_type }
    assert_redirected_to component_path(assigns(:component))
  end
