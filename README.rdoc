...
with a staging application at https://fathomless-escarpment-2251-eu.herokuapp.com.
...
The app uses the following buildpacks:

    1. https://github.com/heroku/heroku-buildpack-ruby
    2. https://github.com/gunpowderlabs/buildpack-ruby-rake-deploy-tasks

Show all currently active buildpacks for the app with

    heroku buildpacks --app fathomless-escarpment-2251-eu

Using the <code>rake-deploy-tasks</code> buildpack, we automatically run pending database migrations after each deploy (set through <code>DEPLOY_TASKS</code>):

    heroku config:set DEPLOY_TASKS='db:migrate'

To add the buildpack to a (new) Heroku app, run:

    heroku buildpacks:set https://github.com/heroku/heroku-buildpack-ruby --app <app-name>
    heroku buildpacks:add https://github.com/gunpowderlabs/buildpack-ruby-rake-deploy-tasks --app <app-name>
    heroku config:set DEPLOY_TASKS='db:migrate'

== Communication & Organization

Planning and development of the Cloud Stove is coordinated on Trello:

* The {Cloud Stove Organization}[https://trello.com/thestove]
* {Cloud Stove Roadmap}[https://trello.com/b/JO3lR0c0/cloud-stove-roadmap]
* {Cloud Stove Development}[https://trello.com/b/UC8jBtDg/cloud-stove-development]
